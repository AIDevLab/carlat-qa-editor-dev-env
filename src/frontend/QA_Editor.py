...
sys.path.append("/mount/src/caralt-qa-editor-dev-env")
...
with st.container(border=False):
    ...
    if st.button("Get Quotes"): 
        if not st.session_state.keywords_extracted:
            ...
            # print("------------------------------------------------")
            st.session_state.topics_dict = update_topic_assignment(redundant_quotes_dict, st.session_state.topics_dict)
            # print("*************************************************")
            # print(st.session_state.topics_dict)
            # print("------------------------------------------------")
